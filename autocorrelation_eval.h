#ifndef W_MODEL_AUTOCORRELATION_EVAL_H
#define W_MODEL_AUTOCORRELATION_EVAL_H
...
#include "paradiseo/mo/src/neighborhood/moRndWithReplNeighborhood.h" // visit one random neighbor possibly the same one several times

//-----------------------------------------------------------------------------
// the sampling class
#include "paradiseo/mo/src/sampling/moAutocorrelationSampling.h"
...
void calculate_autocorrelation(int argc, char **argv)
{
    /* =========================================================
     *
     * Parameters
...
#endif //W_MODEL_AUTOCORRELATION_EVAL_H
